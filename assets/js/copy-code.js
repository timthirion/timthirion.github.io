// Decorate code blocks with copy + GitHub-source buttons.
// The GitHub button only appears when the kramdown IAL `{:data-src="…"}`
// attached a URL to the block's outer wrapper.
document.addEventListener("DOMContentLoaded", function() {
  ...
  const ghIcon = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
